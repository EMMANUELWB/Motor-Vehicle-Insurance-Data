...
* **Extracted file:** - [Clean Dataset (Excel, full)](data_clean/Motor_vehicle_insurance_data_AL.xlsx)  
- [Clean Dataset (CSV, sample preview)](data_clean/Motor_vehicle_insurance_data_AL_sample.csv)  
